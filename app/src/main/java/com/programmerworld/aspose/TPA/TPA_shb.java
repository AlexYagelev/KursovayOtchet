package com.programmerworld.aspose.TPA;
...
import com.programmerworld.aspose.MainViewModel;
import com.programmerworld.aspose.R;
import com.programmerworld.aspose.TPA.pr1.path1;
...
public class TPA_shb  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tpa_shb);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, path1.class);
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, Activity_1_p1.class);
                startActivity(intent);
        ...
        findViewById(R.id.button3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, Activity_type_sos_3pr_1.class);
                startActivity(intent);
        ...
        findViewById(R.id.button4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, Activity_type_sos_4pr_1.class);
                startActivity(intent);
        ...
        findViewById(R.id.button5).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, Activity_type_sos_5pr_1.class);
                startActivity(intent);
        ...
        findViewById(R.id.button6).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, Activity_type_sos_6pr_1.class);
                startActivity(intent);
        ...
        findViewById(R.id.button7).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TPA_shb.this, Activity_type_sos_7pr_1.class);
                startActivity(intent);
