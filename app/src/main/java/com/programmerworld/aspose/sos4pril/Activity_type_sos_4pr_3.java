...
public class Activity_type_sos_4pr_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_type_sos4pr3);

        findViewById(R.id.button1).setOnClickListener(v -> {

            //save();
            Intent intent = new Intent(com.programmerworld.aspose.sos4pril.Activity_type_sos_4pr_3.this, Activity_type_SHB1.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            com.programmerworld.aspose.sos4pril.Activity_type_sos_4pr_3.this.finish();
...
// Вставить значение в первую ячейку
            ...
            dataSaver.saveData2_3_4pr(user);clearFields();
