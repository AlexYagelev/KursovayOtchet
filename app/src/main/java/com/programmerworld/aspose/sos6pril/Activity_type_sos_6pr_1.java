...
public class Activity_type_sos_6pr_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button1).setOnClickListener(v -> {
            ...
            //save();
            Intent intent = new Intent(com.programmerworld.aspose.sos6pril.Activity_type_sos_6pr_1.this, Activity_type_sos_5pr_2.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            com.programmerworld.aspose.sos6pril.Activity_type_sos_6pr_1.this.finish();
...
// Вставить значение в первую ячейку
            ...
            dataSaver.saveData2_2_6pr(user);
