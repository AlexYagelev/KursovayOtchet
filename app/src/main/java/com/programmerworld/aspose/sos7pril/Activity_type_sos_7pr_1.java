...
import com.programmerworld.aspose.sos5pril.Activity_type_sos_5pr_2;

public class Activity_type_sos_7pr_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_type_sos7pr1);

        findViewById(R.id.button1).setOnClickListener(v -> {

            //save();
            Intent intent = new Intent(com.programmerworld.aspose.sos7pril.Activity_type_sos_7pr_1.this, Activity_type_sos_5pr_2.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            com.programmerworld.aspose.sos7pril.Activity_type_sos_7pr_1.this.finish();
...
// Вставить значение в первую ячейку
            ...
            dataSaver.saveData2_2_7pr(user);clearFields();
