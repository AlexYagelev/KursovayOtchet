...
import com.programmerworld.aspose.ExcelDataSaverAct1;
import com.programmerworld.aspose.MainActivity;
...
public class Activity_type_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.b1).setOnClickListener(v -> {
            if (ContextCompat.checkSelfPermission(Activity_type_1.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    == PackageManager.PERMISSION_GRANTED) {
                save_1();
                Intent intent1 = new Intent(Activity_type_1.this, Activity_type_1_1.class);
                //intent1.putExtra("uri", uri.toString());

                startActivity(intent1);
            } else {
                // Запрос разрешения
                ActivityCompat.requestPermissions(Activity_type_1.this,
        ...
        findViewById(R.id.button3).setOnClickListener(v -> {
                ...
                Intent intent2 = new Intent(Activity_type_1.this, MainActivity.class);
                //intent1.putExtra("uri", uri.toString());
    ...
    private void save_1(){
        ExcelDataSaverAct1 dataSaver_1 = new ExcelDataSaverAct1("example.xlsx");
        try {



            EditText editText11 = findViewById(R.id.editText_1);
            String text11 = editText11.getText().toString();

            EditText editText12 = findViewById(R.id.editText_2);
            String text12 = editText12.getText().toString();

            EditText editText13 = findViewById(R.id.editText_3);
            String text13 = editText13.getText().toString();

            EditText editText14 = findViewById(R.id.editText_4);
            String text14 = editText14.getText().toString();

            EditText editText15 = findViewById(R.id.editText_5);
            String text15 = editText15.getText().toString();

            EditText editText16 = findViewById(R.id.editText_6);
