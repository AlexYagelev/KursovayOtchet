...
package com.programmerworld.aspose.sosudi.sos4pril;
...
public class Activity_type_sos_4pr_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button1).setOnClickListener(v -> {
            ...
            //save();
            Intent intent = new Intent(Activity_type_sos_4pr_2.this, Activity_type_sos_4pr_3.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            Activity_type_sos_4pr_2.this.finish();
