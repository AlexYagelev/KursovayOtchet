...
package com.programmerworld.aspose.sosudi.sos5pril;
...
public class Activity_type_sos_5pr_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button1).setOnClickListener(v -> {
            ...
            //save();
            Intent intent = new Intent(Activity_type_sos_5pr_1.this, Activity_type_sos_5pr_2.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            Activity_type_sos_5pr_1.this.finish();
