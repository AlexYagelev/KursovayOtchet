...
import com.programmerworld.aspose.sosudi.Activity_type_2b6;
...
public class Activity_type_sos_6pr_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_type_sos6pr2);

        findViewById(R.id.button1).setOnClickListener(v -> {

            //save();
            Intent intent = new Intent(Activity_type_sos_6pr_2.this, Activity_type_2b6.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            Activity_type_sos_6pr_2.this.finish();
...
// Вставить значение в первую ячейку
            ...
            dataSaver.saveData4_6pr(user);clearFields();
