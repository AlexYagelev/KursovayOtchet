...
import com.programmerworld.aspose.sosudi.sos4pril.Activity_type_sos_4pr_2;
...
public class Activity_type_sos_7pr_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button1).setOnClickListener(v -> {
            ...
            //save();
            Intent intent = new Intent(Activity_type_sos_7pr_2.this, Activity_type_sos_4pr_2.class);
        ...
        findViewById(R.id.button2).setOnClickListener(v -> {
            ...
            //save();
            Activity_type_sos_7pr_2.this.finish();
...
// Вставить значение в первую ячейку
            ...
            dataSaver.saveData2_2_7pr(user);clearFields() ;Toast.makeText(this, "Данные сохранены успешно", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
